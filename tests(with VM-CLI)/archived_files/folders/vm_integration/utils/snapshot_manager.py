...
def create_external_snapshot(vm_name: str, snapshot_name: str = "practice_external_snapshot", 
                           description: str = "Practice session snapshot") -> bool:
    """Legacy function - create external snapshot."""
    try:
        ...
        return manager.create_external_snapshot(domain, snapshot_name, description)
    except Exception as e:
        print(f"Error creating snapshot: {e}")
        return False

def revert_to_snapshot(vm_name: str, snapshot_name: str) -> bool:
    """Legacy function - revert to snapshot.""" 
    try:
        # Import here to avoid circular imports
        from .vm_manager import VMManager
...
def delete_snapshot(vm_name: str, snapshot_name: str) -> bool:
    """Legacy function - delete snapshot."""
    try:
        # Import here to avoid circular imports
        from .vm_manager import VMManager
        ...
        manager = SnapshotManager()
        return manager.delete_external_snapshot(domain, snapshot_name)
    except Exception as e:
