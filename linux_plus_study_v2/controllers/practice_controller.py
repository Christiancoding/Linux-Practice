...
from services.vm_service import VMIntegrationService, VMPracticeSessionResult
...
class PracticeController:
    ...
    def start_vm_practice(self, user_id: int, challenge_type: str) -> VMPracticeSessionResult:
